;(function (exports) {
  ...
  (function (namespace) {
    ...
    if (!namespace.DataView) {
      ...
      Object.defineProperties(DataView.prototype, {
        buffer: { get: function () {
          return this._binary.buffer;
        }, enumerable: true },
        byteLength: { get: function () {
          return this._binary.byteLength;
        }, enumerable: true },
        byteOffset: { get: function () {
          return this._binary.byteOffset;
        }, enumerable: true },
      ...
      console.log(">>>XX<<<");
      if(exports) exports.DataView = DataView;
    }
  })(this);
  ...
  (function (namespace) {
    ...
    console.log("____");
    var DataView = namespace.DataView;
    ...
    function writeX(f, l) {
      console.log("<<", f, exports.DataView);
      return function (v) {
    ...
    namespace.BufferOutputStream = BufferOutputStream;
    namespace.BufferInputStream = BufferInputStream;
  ...
  (function (namespace) {
    ...
    function Dict(/*capacity, loadFactor*/) {
      ...
      Object.defineProperties(this, {
        ...
        _map: {
          value: function() {
            return exports ? new exports.HashMap() : new HashMap();
          }()
        },
        _hash: {
          value: function (key) {
            switch (this._map.type(key)) {
              ...
              default:
                if (!key._hmuid_) {
                  key._hmuid_ = exports ? exports.HashMap : ++HashMap.uid;
